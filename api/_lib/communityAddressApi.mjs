...
const createAddressFromDraft = async (body) => {
  ...
  return Address.create({
    ...
    state: city.state,
    city: city.city_name,
    communityName: body.communityName || body.community_name || null,
    ...
    buildingPolygonId: body.buildingPolygonId || body.building_polygon_id || null,
    phoneNumber: body.phoneNumber || body.phone_number || null,
    entranceLabel: body.entranceLabel || body.entrance_label || null,
    entranceLatitude: body.entranceLatitude ?? body.entrance_latitude ?? null,
    entranceLongitude: body.entranceLongitude ?? body.entrance_longitude ?? null,
    confidenceScore: body.confidenceScore ?? body.confidence_score ?? 0,
...
export const handleCommunityGenerate = async (req, res) => {
  ...
  try {
    ...
    const address = await AddressService.generateAddress(latitude, longitude, {
      ...
      communityName: body.communityName || body.community_name || '',
      district: body.district || '',
      buildingPolygonId: body.buildingPolygonId || body.building_polygon_id || '',
      phoneNumber: body.phoneNumber || body.phone_number || '',
      entranceLabel: body.entranceLabel || body.entrance_label || '',
      entranceLatitude: body.entranceLatitude ?? body.entrance_latitude ?? null,
      entranceLongitude: body.entranceLongitude ?? body.entrance_longitude ?? null,
      gpsAccuracy: body.gpsAccuracy ?? body.gps_accuracy ?? null,
...
export const handleCommunityDetailsUpdate = async (req, res, id) => {
  ...
  try {
    ...
    let address = await Address.updateDetails(id, {
      ...
      community_name: body.communityName || body.community_name || null,
      landmark: body.landmark || null,
      street_description: body.streetDescription || body.street_description || body.description || null,
      description: body.description || body.streetDescription || body.street_description || null,
      district: body.district || null,
      building_polygon_id: body.buildingPolygonId || body.building_polygon_id || null,
      phone_number: body.phoneNumber || body.phone_number || null,
      entrance_label: body.entranceLabel || body.entrance_label || null,
      entrance_latitude: body.entranceLatitude ?? body.entrance_latitude ?? null,
      entrance_longitude: body.entranceLongitude ?? body.entrance_longitude ?? null,
      confidence_score: body.confidenceScore ?? body.confidence_score ?? 0,
